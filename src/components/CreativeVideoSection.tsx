...
export const CreativeVideoSection = () => {
  ...
  return (
    <section className="py-28 md:py-36 bg-[#FBFAF7] border-b border-neutral-200/70 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
            ...
            >
              <div>
                <div className="flex items-center justify-between pb-4 border-b border-neutral-100 mb-5">
                  <span className="font-mono text-xs font-semibold text-neutral-400 group-hover:text-blue-600 transition-colors">
                    0{idx + 1}
                  </span>
                  <span className="text-[10px] font-mono uppercase tracking-wider text-neutral-400 bg-neutral-100 px-2 py-0.5 rounded">
                    {svc.tag}
                  </span>
                </div>
                <h3 className="font-serif-display text-xl font-semibold text-neutral-900 mb-3 leading-snug">
                  {svc.title}
                </h3>
              ...
              <div className="pt-6 mt-4 border-t border-neutral-100 flex items-center justify-between text-xs text-neutral-500 font-medium">
        ...
        <div className="relative rounded-[32px] overflow-hidden border border-neutral-800 bg-[#0B0F19] text-white p-8 sm:p-14 shadow-2xl">
